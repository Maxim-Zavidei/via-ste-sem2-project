...
public class UserView
{
  ...
  public UserView(User user){
    ...
    this.status = new SimpleStringProperty(user.userType(user));
  }
  ...
  public StringProperty getStatus(){return firstName;}
  public StringProperty getGender(){ return gender;}
  public ObjectProperty<DateTime> getBirthDate(){return birthDate;}
}
